    ...
    return (
        ...
        >
            <div onClick={(event) => event.stopPropagation()}
                ...
                <p className='my-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi doloribus ullam, ea ad, minima iure et iste distinctio fugit animi accusamus ab qui. Laborum natus odit sint fugit, hic molestiae.</p>
            </div>
        </div>
    )
}
